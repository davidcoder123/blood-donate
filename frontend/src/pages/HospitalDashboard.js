...
export default function HospitalDashboard() {
  ...
  const s = {
    ...
    urg:     (u) => ({ background: urgColor[u]+'20', color:urgColor[u], fontSize:'11px', fontWeight:700, padding:'3px 10px', borderRadius:'9px' }),
    stat: (s) => ({ background: s==='open'?'#dbeafe':s==='fulfilled'?'#dcfce7':s==='expired'?'#fee2e2':'#f3f4f6', color: s==='open'?'#1d4ed8':s==='fulfilled'?'#15803d':s==='expired'?'#b91c1c':'#6b7280', fontSize:'11px', fontWeight:700, padding:'3px 10px', borderRadius:'9px' }),
