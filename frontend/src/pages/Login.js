...
export default function Login() {
  ...
  const s = {
    ...
    btn:   { width: '100%', background: '#dc2626', color: 'white', border: 'none', padding: '12px', borderRadius: '10px', fontSize: '15px', fontWeight: 700, cursor: 'pointer', marginTop: '4px' },
    links: { textAlign: 'center', marginTop: '20px', fontSize: '13px', color: '#6b7280' },
    link:  { color: '#dc2626', textDecoration: 'none', fontWeight: 600 },
    forgot:{ display: 'block', textAlign: 'right', fontSize: '12px', color: '#dc2626', textDecoration: 'none', marginTop: '-10px', marginBottom: '14px' }
  };
